...
DEB_RELEASES="jessie stretch buster xenial bionic eoan focal"
RPM_RELEASES="$(/bin/bash -c 'echo fedora-{30,31,32}-{x86_64,i386}') epel-6-x86_64 epel-7-coda-x86_64 epel-8-x86_64"
